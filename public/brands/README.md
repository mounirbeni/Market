...
هاد المجلد فيه **83 شعاراً محلياً**: 31 ملف SVG و52 ملف PNG. الواجهة كتختار الامتداد المناسب تلقائياً، والباقي كيتعرض بشارة نصية مصمّمة.
...
| صور بعثها المستخدم (بحث Google، خلفية بيضاء حُيّدت آلياً) | خاص التحقق من المصدر الأصلي قبل الإطلاق التجاري | Kawasaki، Benelli، MBK، SYM، Docker، Haojue، DFSK، GWM، Jaecoo، KGM، Lynk & Co، Neo Motors، Omoda، Seres |

## الماركات التي ما زالت بلا شعار محلي

الماركة الوحيدة الناقصة دابا فكل الكتالوج:
