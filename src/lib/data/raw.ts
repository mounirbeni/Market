...
export const RAW: RawListing[] = [
  ...
  { id: "c061", kind: "car", make: "Ford", model: "Ranger", version: "2.2 TDCi 4x4 XLT", year: 2018, km: 148000, price: 312000, fuel: "diesel", gearbox: "manuelle", body: "utilitaire", cv: 9, conso: 7.4, city: "agadir", cond: "bon", doors: 4 },
  { id: "c062", kind: "car", make: "Isuzu", model: "D-Max", version: "1.9 Ddi 4x4 LSX", year: 2019, km: 122000, price: 298000, fuel: "diesel", gearbox: "manuelle", body: "utilitaire", cv: 8, conso: 7.0, city: "dakhla", cond: "tres-bon", doors: 4 },
  { id: "c063", kind: "car", make: "Toyota", model: "Hilux", version: "2.4 D-4D 4x2 Simple Cab", year: 2016, km: 198000, price: 236000, fuel: "diesel", gearbox: "manuelle", body: "utilitaire", cv: 8, conso: 7.1, city: "laayoune", cond: "bon", doors: 2 },
  { id: "c064", kind: "car", make: "Renault", model: "Zoe", version: "R110 Intens", year: 2020, km: 61000, price: 218000, fuel: "electrique", gearbox: "automatique", body: "citadine", cv: 5, conso: 17.2, city: "casablanca", cond: "tres-bon", doors: 5 },
  { id: "c065", kind: "car", make: "Dacia", model: "Spring", version: "Electric 45 Comfort", year: 2022, km: 38000, price: 168000, fuel: "electrique", gearbox: "automatique", body: "citadine", cv: 4, conso: 14.5, city: "rabat", cond: "excellent", doors: 5 },
  { id: "c066", kind: "car", make: "Hyundai", model: "Kona", version: "Electric 64 kWh Executive", year: 2021, km: 54000, price: 385000, fuel: "electrique", gearbox: "automatique", body: "suv", cv: 7, conso: 16.8, city: "casablanca", cond: "excellent", doors: 5 },
  { id: "c067", kind: "car", make: "Tesla", model: "Model 3", version: "Long Range AWD", year: 2022, km: 41000, price: 545000, fuel: "electrique", gearbox: "automatique", body: "berline", cv: 9, conso: 16.2, city: "rabat", cond: "excellent", doors: 4 },
  { id: "c068", kind: "car", make: "Peugeot", model: "Partner", version: "1.5 BlueHDi Fourgon", year: 2020, km: 96000, price: 152000, fuel: "diesel", gearbox: "manuelle", body: "utilitaire", cv: 6, conso: 4.8, city: "casablanca", cond: "tres-bon", doors: 4 },
  { id: "c069", kind: "car", make: "Volkswagen", model: "Caddy", version: "2.0 TDI Fourgon", year: 2018, km: 138000, price: 148000, fuel: "diesel", gearbox: "manuelle", body: "utilitaire", cv: 7, conso: 5.2, city: "tanger", cond: "bon", doors: 4 },

  { id: "m023", kind: "moto", make: "Yamaha", model: "Ténéré 700", version: "ABS", year: 2021, km: 21000, price: 128000, fuel: "essence", gearbox: "manuelle", body: "trail", cv: 8, conso: 4.4, city: "casablanca", cond: "tres-bon", cc: 689 },
  { id: "m024", kind: "moto", make: "Honda", model: "Transalp 750", version: "XL750", year: 2023, km: 12000, price: 142000, fuel: "essence", gearbox: "manuelle", body: "trail", cv: 9, conso: 4.6, city: "rabat", cond: "excellent", cc: 755 },
  { id: "m025", kind: "moto", make: "Kawasaki", model: "Ninja 650", version: "ABS", year: 2020, km: 19000, price: 78000, fuel: "essence", gearbox: "manuelle", body: "sportive", cv: 7, conso: 4.3, city: "casablanca", cond: "tres-bon", cc: 649 },
  { id: "m026", kind: "moto", make: "Yamaha", model: "R6", version: "YZF-R6", year: 2017, km: 29000, price: 92000, fuel: "essence", gearbox: "manuelle", body: "sportive", cv: 9, conso: 5.6, city: "marrakech", cond: "bon", cc: 599 },
  { id: "m027", kind: "moto", make: "Honda", model: "CBR 600RR", version: "ABS", year: 2015, km: 38000, price: 78000, fuel: "essence", gearbox: "manuelle", body: "sportive", cv: 9, conso: 5.9, city: "tanger", cond: "bon", cc: 599 },
  { id: "m028", kind: "moto", make: "Honda", model: "Forza 125", version: "ABS", year: 2021, km: 15000, price: 42000, fuel: "essence", gearbox: "automatique", body: "scooter", cv: 2, conso: 2.4, city: "rabat", cond: "excellent", cc: 125 },
  { id: "m029", kind: "moto", make: "Kymco", model: "Agility 125", version: "City", year: 2021, km: 21000, price: 15500, fuel: "essence", gearbox: "automatique", body: "scooter", cv: 2, conso: 2.5, city: "marrakech", cond: "bon", cc: 125 },
  { id: "m030", kind: "moto", make: "Peugeot", model: "Django", version: "125 Allure", year: 2020, km: 17000, price: 24000, fuel: "essence", gearbox: "automatique", body: "scooter", cv: 2, conso: 2.5, city: "marrakech", cond: "tres-bon", cc: 125 },
  { id: "m031", kind: "moto", make: "SYM", model: "Jet 14", version: "125", year: 2022, km: 12000, price: 17000, fuel: "essence", gearbox: "automatique", body: "scooter", cv: 2, conso: 2.4, city: "fes", cond: "excellent", cc: 125 },
  { id: "m032", kind: "moto", make: "BMW", model: "F 850 GS", version: "Adventure", year: 2019, km: 34000, price: 145000, fuel: "essence", gearbox: "manuelle", body: "trail", cv: 9, conso: 4.7, city: "rabat", cond: "tres-bon", cc: 853 },
  { id: "m033", kind: "moto", make: "Harley-Davidson", model: "Forty-Eight", version: "XL1200X", year: 2019, km: 18000, price: 128000, fuel: "essence", gearbox: "manuelle", body: "custom", cv: 10, conso: 5.1, city: "marrakech", cond: "excellent", cc: 1202 },
  { id: "m034", kind: "moto", make: "Royal Enfield", model: "Meteor 350", version: "Fireball", year: 2022, km: 11000, price: 42000, fuel: "essence", gearbox: "manuelle", body: "custom", cv: 4, conso: 2.9, city: "casablanca", cond: "excellent", cc: 349 },
  { id: "m035", kind: "moto", make: "Bajaj", model: "Pulsar", version: "NS200", year: 2021, km: 24000, price: 22000, fuel: "essence", gearbox: "manuelle", body: "roadster", cv: 3, conso: 2.9, city: "oujda", cond: "tres-bon", cc: 199 },
];
