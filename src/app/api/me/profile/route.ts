...
/* ============================================================
   ...
   ماكاينش توثيق للرقم برسالة SMS: المنصة ماعندهاش مزوّد، وحيدنا
   هاد الشرط بالكامل من مؤشرات الثقة بدل ما نطالبو المستعملين
   بحاجة ماكيناش. الرقم كيتخزّن كما دخّلو صاحبو، وهو وسيلة تواصل
   ماشي دليل هوية.
