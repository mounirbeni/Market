...
export const metadata: Metadata = {
  title: "مركز المساعدة",
  description: "أجوبة على الأسئلة الأكثر تكراراً حول النشر، البحث، الثقة، الأثمنة والفحص في منصة طريق.",
...
const TOPICS = [
  ...
  { Icon: Coins, title: "الأثمنة والتكلفة", href: "#pricing" },
];
...
const FAQ: { id: string; heading: string; items: { q: string; a: string }[] }[] = [
  {
    ...
    items: [
      {
        q: "بأي لغة كنكتب فخانة البحث؟",
        a: "أسماء الماركات والموديلات كتُكتب دائماً بالحروف اللاتينية، كيف ما هي فالبطاقة الرمادية: Dacia Logan، Mercedes Classe C، Golf 7 TDI، Yamaha MT-07. حيت كتكتب أول حرف كتبان ليك لائحة اقتراحات — كتب M وغادي تلقى Mercedes وMBK وMitsubishi. المصطلحات التقنية (Diesel، Essence، Automatique، Citadine، SUV) مقبولة بالفرنسية. إلا كتبتي بالعربية كنقترحو عليك الكتابة اللاتينية الصحيحة.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        q: "واش كتوفّرو التمويل ولا القروض؟",
        a: "لا. طريق منصة إعلانات فقط — كنربطو المشتري بالبائع وصافي. ماكنمولوش، ماكنقرضوش، وماكنعطيوش نصائح مالية. إلا بغيتي تمويل، تواصل مباشرة مع بنك ولا شركة تمويل.",
      },
    ],
  },
];
    ...
    <div className="mx-auto max-w-[900px] px-4 py-12">
      ...
      >
        ...
        <div className="mt-5 flex flex-wrap justify-center gap-2">
          <Link href="/contact" className="btn btn-primary btn-sm">اتصل بنا <ArrowLeft size={14} className="dir-flip" /></Link>
